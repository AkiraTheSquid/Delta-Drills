...
- `build_solution_colabs.py`: `dd_questions.json` + `authored/*.jsonl` → `arena-procedural-drills/solutions/<topic>/q<ID>-<sub>.ipynb`, plus the id→path and id→hint manifests.
