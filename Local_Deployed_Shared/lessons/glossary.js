...
window.DD_GLOSSARY.kcLesson = {
  ...
  "numpy.ndarray-model": ["Arrays from the ground up", "What an ndarray is: data + shape + dtype"],
  ...
  "numpy.constructors": ["Arrays from the ground up", "Array constructors: zeros, ones, full, empty, eye"],
  ...
  "numpy.dtype-astype": ["Arrays from the ground up", "Dtypes, astype, and memory size"],
  "numpy.reshape-flatten": ["Arrays from the ground up", "Reshape, ravel, and element order"],
  "numpy.elementwise-ufuncs": ["Arrays from the ground up", "Elementwise math (ufuncs)"],
  "numpy.aggregations": ["Arrays from the ground up", "Whole-array aggregations and Python scalars"],
  "numpy.sorting": ["Arrays from the ground up", "Sorting arrays"],
  ...
  "numpy.random-threading": ["Arrays from the ground up", "Using a stream you were handed"],
  "numpy.linalg-basics": ["Arrays from the ground up", "Matrix multiply and np.linalg basics"],
