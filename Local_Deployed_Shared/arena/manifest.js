...
const ARENA_CURRICULUM = [
  ...
  { id: "arena-0.0-prereqs", chapter: "chapter0_fundamentals", section: "0.0 Prerequisites", title: "Prerequisites",
    notebookPath: "content/ARENA_4.0-main/chapter0_fundamentals/exercises/part0_prereqs/0.0_Prerequisites_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter0_fundamentals/instructions/pages/00_[0.0]_Prerequisites.md",
    placeholderScore: 78 },
  { id: "arena-0.1-ray-tracing", chapter: "chapter0_fundamentals", section: "0.1 Ray Tracing", title: "Ray Tracing",
    notebookPath: "content/ARENA_4.0-main/chapter0_fundamentals/exercises/part1_ray_tracing/0.1_Ray_Tracing_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter0_fundamentals/instructions/pages/01_[0.1]_Ray_Tracing.md",
    placeholderScore: 64 },
  { id: "arena-0.2-cnns-and-resnets", chapter: "chapter0_fundamentals", section: "0.2 CNNs & ResNets", title: "CNNs & ResNets",
    notebookPath: "content/ARENA_4.0-main/chapter0_fundamentals/exercises/part2_cnns/0.2_CNNs_&_ResNets_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter0_fundamentals/instructions/pages/02_[0.2]_CNNs_&_ResNets.md",
    placeholderScore: 70 },
  { id: "arena-0.3-optimization", chapter: "chapter0_fundamentals", section: "0.3 Optimization", title: "Optimization",
    notebookPath: "content/ARENA_4.0-main/chapter0_fundamentals/exercises/part3_optimization/0.3_Optimization_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter0_fundamentals/instructions/pages/03_[0.3]_Optimization.md",
    placeholderScore: 60 },
  { id: "arena-0.4-backprop", chapter: "chapter0_fundamentals", section: "0.4 Backprop", title: "Backprop",
    notebookPath: "content/ARENA_4.0-main/chapter0_fundamentals/exercises/part4_backprop/0.4_Backprop_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter0_fundamentals/instructions/pages/04_[0.4]_Backprop.md",
    placeholderScore: 55 },
  { id: "arena-0.5-vaes-and-gans", chapter: "chapter0_fundamentals", section: "0.5 VAEs & GANs", title: "VAEs & GANs",
    notebookPath: "content/ARENA_4.0-main/chapter0_fundamentals/exercises/part5_vaes_and_gans/0.5_VAEs_&_GANs_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter0_fundamentals/instructions/pages/05_[0.5]_VAEs_&_GANs.md",
    placeholderScore: 50 },
  ...
  { id: "arena-1.1-transformer-from-scratch", chapter: "chapter1_transformer_interp", section: "1.1 Transformer from Scratch", title: "Transformer from Scratch",
    notebookPath: "content/ARENA_4.0-main/infrastructure/master_files/master_1_1.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter1_transformer_interp/instructions/pages/01_[1.1]_Transformer_from_Scratch.md",
    placeholderScore: 50 },
  { id: "arena-1.2-intro-to-mech-interp", chapter: "chapter1_transformer_interp", section: "1.2 Intro to Mech Interp", title: "Intro to Mech Interp",
    notebookPath: "content/ARENA_4.0-main/chapter1_transformer_interp/exercises/part2_intro_to_mech_interp/1.2_Intro_to_Mech_Interp_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter1_transformer_interp/instructions/pages/02_[1.2]_Intro_to_Mech_Interp.md",
    placeholderScore: 45 },
  { id: "arena-1.3.1-superposition-and-saes", chapter: "chapter1_transformer_interp", section: "1.3.1 Superposition & SAEs", title: "Toy Models of Superposition & SAEs",
    notebookPath: "content/ARENA_4.0-main/infrastructure/master_files/master_1_3_1.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter1_transformer_interp/instructions/pages/11_🧬_[1.3.1]_Toy_Models_of_Superposition_&_SAEs.md",
    placeholderScore: 40 },
  { id: "arena-1.3.2-interp-with-saes", chapter: "chapter1_transformer_interp", section: "1.3.2 Interp with SAEs", title: "Interpretability with SAEs",
    notebookPath: "content/ARENA_4.0-main/chapter1_transformer_interp/exercises/part32_interp_with_saes/1.3.2_Interpretability_with_SAEs_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter1_transformer_interp/instructions/pages/12_🧬_[1.3.2]_Interpretability_with_SAEs.md",
    placeholderScore: 38 },
  { id: "arena-1.4.1-ioi", chapter: "chapter1_transformer_interp", section: "1.4.1 IOI", title: "Indirect Object Identification",
    notebookPath: "content/ARENA_4.0-main/infrastructure/master_files/master_1_4_1.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter1_transformer_interp/instructions/pages/21_📚_[1.4.1]_Indirect_Object_Identification.md",
    placeholderScore: 35 },
  { id: "arena-1.4.2-function-vectors", chapter: "chapter1_transformer_interp", section: "1.4.2 Function Vectors", title: "Function Vectors & Model Steering",
    notebookPath: "content/ARENA_4.0-main/infrastructure/master_files/master_1_4_2.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter1_transformer_interp/instructions/pages/22_📚_[1.4.2]_Function_Vectors_&_Model_Steering.md",
    placeholderScore: 35 },
  { id: "arena-1.5.1-balanced-brackets", chapter: "chapter1_transformer_interp", section: "1.5.1 Balanced Brackets", title: "Balanced Bracket Classifier",
    notebookPath: "content/ARENA_4.0-main/infrastructure/master_files/master_1_5_1.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter1_transformer_interp/instructions/pages/31_🔬_[1.5.1]_Balanced_Bracket_Classifier.md",
    placeholderScore: 38 },
  { id: "arena-1.5.2-grokking", chapter: "chapter1_transformer_interp", section: "1.5.2 Grokking", title: "Grokking & Modular Arithmetic",
    notebookPath: "content/ARENA_4.0-main/infrastructure/master_files/master_1_5_2.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter1_transformer_interp/instructions/pages/32_🔬_[1.5.2]_Grokking_&_Modular_Arithmetic.md",
    placeholderScore: 33 },
  { id: "arena-1.5.3-othellogpt", chapter: "chapter1_transformer_interp", section: "1.5.3 OthelloGPT", title: "OthelloGPT",
    notebookPath: "content/ARENA_4.0-main/chapter1_transformer_interp/exercises/part53_othellogpt/1.5.3_OthelloGPT_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter1_transformer_interp/instructions/pages/33_🔬_[1.5.3]_OthelloGPT.md",
    placeholderScore: 30 },

  // Chapter 2 — Reinforcement Learning
  { id: "arena-2.1-intro-to-rl", chapter: "chapter2_rl", section: "2.1 Intro to RL", title: "Intro to RL",
    notebookPath: "content/ARENA_4.0-main/chapter2_rl/exercises/part1_intro_to_rl/2.1_Intro_to_RL_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter2_rl/instructions/pages/10_[2.1]_Intro_to_RL.md",
    placeholderScore: 41 },
  { id: "arena-2.2.1-dqn", chapter: "chapter2_rl", section: "2.2.1 DQN", title: "Deep Q Networks",
    notebookPath: "content/ARENA_4.0-main/chapter2_rl/exercises/part21_dqn/2.2.1_Deep_Q_Networks_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter2_rl/instructions/pages/20_[2.2.1]_Deep_Q_Networks.md",
    placeholderScore: 38 },
  { id: "arena-2.2.2-policy-gradient", chapter: "chapter2_rl", section: "2.2.2 Policy Gradient", title: "Policy Gradient",
    notebookPath: "content/ARENA_4.0-main/chapter2_rl/exercises/part22_vpg/2.2.2_Policy_Gradient_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter2_rl/instructions/pages/21_[2.2.2]_Policy_Gradient.md",
    placeholderScore: 35 },
  { id: "arena-2.3-ppo", chapter: "chapter2_rl", section: "2.3 PPO", title: "PPO",
    notebookPath: "content/ARENA_4.0-main/chapter2_rl/exercises/part3_ppo/2.3_PPO_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter2_rl/instructions/pages/30_[2.3]_PPO.md",
    placeholderScore: 32 },
  { id: "arena-2.4-rlhf", chapter: "chapter2_rl", section: "2.4 RLHF", title: "RLHF",
    notebookPath: "content/ARENA_4.0-main/chapter2_rl/exercises/part4_rlhf/2.4_RLHF_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter2_rl/instructions/pages/40_[2.4]_RLHF.md",
    placeholderScore: 30 },

  // Chapter 3 — LLM Evals
  { id: "arena-3.1-intro-to-evals", chapter: "chapter3_llm_evals", section: "3.1 Intro to Evals", title: "Intro to Evals",
    notebookPath: "content/ARENA_4.0-main/chapter3_llm_evals/exercises/part1_intro_to_evals/3.1_Intro_to_Evals_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter3_llm_evals/instructions/pages/01_[3.1]_Intro_to_Evals.md",
    placeholderScore: 53 },
  { id: "arena-3.2-dataset-generation", chapter: "chapter3_llm_evals", section: "3.2 Dataset Generation", title: "Dataset Generation",
    notebookPath: "content/ARENA_4.0-main/chapter3_llm_evals/exercises/part2_dataset_generation/3.2_Dataset_Generation_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter3_llm_evals/instructions/pages/02_[3.2]_Dataset_Generation.md",
    placeholderScore: 48 },
  { id: "arena-3.3-running-evals-with-inspect", chapter: "chapter3_llm_evals", section: "3.3 Running Evals with Inspect", title: "Running Evals with Inspect",
    notebookPath: "content/ARENA_4.0-main/chapter3_llm_evals/exercises/part3_running_evals_with_inspect/3.3_Running_Evals_with_Inspect_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter3_llm_evals/instructions/pages/03_[3.3]_Running_Evals_with_Inspect.md",
    placeholderScore: 45 },
  { id: "arena-3.4-llm-agents", chapter: "chapter3_llm_evals", section: "3.4 LLM Agents", title: "LLM Agents",
    notebookPath: "content/ARENA_4.0-main/chapter3_llm_evals/exercises/part4_llm_agents/3.4_LLM_Agents_exercises.ipynb",
    lessonPath: "content/ARENA_4.0-main/chapter3_llm_evals/instructions/pages/04_[3.4]_LLM_Agents.md",
    placeholderScore: 40 },
];
...
const buildArenaProblem = (entry) => {
  ...
  return {
    ...
    backupNotebookPath: entry.notebookPath.replace(
