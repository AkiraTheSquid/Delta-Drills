...
#     ...
# ]
metadata = [{'title': 'TMS: Superposition in a Nonprivileged Basis', 'icon': '1-circle-fill', 'subtitle': '(25%)'}, {'title': 'TMS: Superposition in a Privileged Basis', 'icon': '2-circle-fill', 'subtitle': '(10%)'}, {'title': 'Feature Geometry', 'icon': '3-circle-fill', 'subtitle': '(10%)'}, {'title': 'Superposition & Deep Double Descent', 'icon': '4-circle-fill', 'subtitle': '(10%)'}, {'title': 'Sparse Autoencoders in Toy Models', 'icon': '5-circle-fill', 'subtitle': '(45%)'}, {'title': 'Bonus', 'icon': 'star', 'subtitle': ''}]
chapter_name = 'chapter1_transformer_interp'
chapter_name_long = 'Chapter 1 - Transformer Interp'
section_title = '[1.3.1] Toy Models of Superposition & SAEs'
