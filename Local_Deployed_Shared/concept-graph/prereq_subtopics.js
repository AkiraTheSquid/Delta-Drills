...
window.PREREQ_SUBTOPICS = {
  ...
  "source": "arena-procedural-drills/ notebook metadata (canonical via gen_catalog_entries.py walk)",
  "description": "Prereq subtopic keys introduced by the Colab procedural drills. These keys are NOT in the regular question bank (zero flashcards) \u2014 drills are the only practice surface. Backend questions.py + frontend atom_readiness.js both consume this file to know about them.",
  "atom_to_subtopic": {
