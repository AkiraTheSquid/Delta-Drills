...
def main(argv: list[str]) -> int:
    ...
    csv_path = THIS_DIR_ONLY / "LADR4e_chapters.csv"
    pdf_path = THIS_DIR_ONLY / "LADR4e.pdf"
    output_dir = THIS_DIR_ONLY / "exercise_sections"
    ...
    if len(argv) == 1 and first_chapter_page_1_based is not None:
        try:
            ...
            history_path = THIS_DIR_ONLY / "split_commands_history"
