...
from app.storage import job_runtime_dir
...
def run_auto_toc(
    ...
    chatgpt_runtime_dir = job_runtime_dir(job_id, "chatgpt")
    mathpix_runtime_dir = job_runtime_dir(job_id, "mathpix")
    merged_env = os.environ.copy()
    merged_env["DELTA_CHATGPT_RUNTIME_DIR"] = str(chatgpt_runtime_dir)
    merged_env["DELTA_MATHPIX_RUNTIME_DIR"] = str(mathpix_runtime_dir)
    if openai_api_key:
